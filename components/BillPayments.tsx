...
import { Filter, Download, CreditCard, Eye, Zap, Droplets, Wrench, PartyPopper, X, CheckCircle, Loader2, AlertCircle, Shield } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Your Bills</h2>
          <p className="text-gray-500 dark:text-gray-400">View and manage all your society bills here.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Upcoming Bills</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
          ...
          <p className="text-3xl font-bold text-green-600 dark:text-green-400">₹2,500.00</p>
        </div>
      </div>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-3">
                      ...
                      {bill.status !== BillStatus.PAID && (
                        <button className="text-gray-400 hover:text-green-600 dark:hover:text-green-400 transition">
                          <CreditCard size={18} />
                        </button>
                      )}
                       {bill.status === BillStatus.PAID && (
